/***********************************************************************************|
|
|	Blog Link - https://www.ardanlabs.com/blog/2015/09/composition-with-go.html
|
|***********************************************************************************/
...
// PullNail Removes a nail from the specified board.
func (Crowbar) PullNail(nailSupply *int, b *Board) {

	// Put a nail in to the supply
	*nailSupply++

	// Pull a nail from the board
	b.NailsDriven--

	fmt.Println("Crowbar: removed nail from the board.")
}
